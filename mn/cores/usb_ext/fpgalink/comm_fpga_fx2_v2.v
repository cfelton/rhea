...
assign g_fx2_gotdata = 0;
assign g_f2h_valid_i = 0;
assign g_h2f_ready_i = 0;
assign g_f2h_data_i = 0;
assign g_fx2_gotroom = 0;
...
always @(posedge clk_in, negedge reset_in) begin: COMM_FPGA_FX2_V2_G_HDL_SM
    if (reset_in == 0) begin
        ...
        case (g_state)
            ...
            4'b0110: begin
                if (g_fx2_gotroom) begin
                    g_f2h_ready_o <= 1'b1;
                end
                if ((g_fx2_gotroom && g_f2h_valid_i)) begin
                    g_fifop <= 1;
            ...
            4'b1001: begin
                fx2FifoSel_out <= 0;
                if ((g_fx2_gotdata && g_h2f_ready_i)) begin
                    if ((!g_fx2_read) !== 1) begin
...
assign g_fx2_read = g_fifop[0];
assign g_fx2_write = g_fifop[1];
